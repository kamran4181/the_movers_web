...
=======
                                <p>We’ve got options to get you where you’re going. Choose a vehicle ride. Lorem ipsum
                                    dolor sit, amet consectetur adipisicing elit. Magni voluptas recusandae aliquid aut
                                    perferendis tempora omnis quos esse asperiores consectetur.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="box-items col-md-4 mb-4">
                    <div class="flip-box">
                        <div class="flip-box-front border-0 py-4 shadow rounded text-center bg-white">
                            <h5 class="card-title mb-3"><b>E Go</b></h5>
                            <div class="card-body">
                                <img src="/images/icons/go.png" height="150">
                            </div>
                        </div>
                        <div class="flip-box-back border-0 py-4 shadow rounded text-center">
                            <div class="card-body">
                ...
                <div class="box-items col-md-4 mb-4">
                    <div class="flip-box">
                        <div class="flip-box-front border-0 py-4 shadow rounded text-center bg-white">
                            <h5 class="card-title mb-3"><b>E Premium</b></h5>
                            <div class="card-body">
                                <img src="/images/icons/premium.png" height="150">
                            </div>
                        </div>
                        <div class="flip-box-back border-0 py-4 shadow rounded text-center">
                            <div class="card-body">
                ...
                <div class="box-items col-md-4 mb-4">
                    <div class="flip-box">
                        <div class="flip-box-front border-0 py-4 shadow rounded text-center bg-white">
                            <h5 class="card-title mb-3"><b>Auto</b></h5>
                            <div class="card-body">
                                <img src="/images/icons/Layer 2.png" height="150">
                            </div>
                        </div>
                        <div class="flip-box-back border-0 py-4 shadow rounded text-center">
                            <div class="card-body">
                ...
                <div class="box-items col-md-4 mb-4">
                    <div class="flip-box">
                        <div class="flip-box-front border-0 py-4 shadow rounded text-center bg-white">
                            <h5 class="card-title mb-3"><b>Bike</b></h5>
                            <div class="card-body">
                                <img src="images/icons/bike.png" height="150">
                            </div>
                        </div>
                        <div class="flip-box-back border-0 py-4 shadow rounded text-center">
                            <div class="card-body">
                ...
                <div class="box-items col-md-4 mb-4">
                    <div class="flip-box">
                        <div class="flip-box-front border-0 py-4 shadow rounded text-center bg-white">
                            <h5 class="card-title mb-3"><b>City to City</b></h5>
                            <div class="card-body">
                                <img src="images/icons/airplan.png" height="150">
                            </div>
                        </div>
                        <div class="flip-box-back border-0 py-4 shadow rounded text-center">
                            <div class="card-body">
                                <p>We’ve got options to get you where you’re going. Choose a vehicle ride. Lorem ipsum
                                    dolor sit, amet consectetur adipisicing elit. Magni voluptas recusandae aliquid aut
                                    perferendis tempora omnis quos esse asperiores consectetur.</p>
>>>>>>> 539ade5f49d8620cd9c79f7eaeacbed0260bbfe5:ride_ui.html
                            </div>
                        </div>
                    </div>
                </div>
