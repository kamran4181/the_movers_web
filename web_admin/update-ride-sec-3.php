...
if(isset($_POST['publise'])){
    ...
    if($_FILES['lis_img']['name']!=''){
     ...
     $folder = "../images/ride-img/".$lis_img;
      ...
      $insertdata = mysqli_query($con,"UPDATE ride_ui SET title='$title',section_name='$section_name',descrip='$descrip',img='$lis_img' where id=".$edit."");
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            ...
                            <div class="col-sm-6 text-center">
                               <a href="ride-ui.php" class="btn btn-success"><-- Back ride Page</a>
                            </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="card card-outline card-info">
                                ...
                                <div class="card-header">
                                    ...
                                    <p><img style="width:150px;" src="../images/ride-img/<?php echo $row["img"]; ?>"></p>
                                </div>
