...
if(isset($_POST['publise'])){
    ...
    $lis_img = $_POST['old_img'];
      ...
      $folder = "../images/ride-img/".$lis_img;

      move_uploaded_file($tempname, $folder);
    }

      $insertdata = mysqli_query($con,"UPDATE ride_ui SET title='$title',section_name='$section_name',descrip='$descrip',img='$lis_img',date='$today' where section_name='$section_name'");
    //   echo "<script>alert('Updated Successfully');</script>
    echo "<script>window.location.href = 'ride-ui.php'</script>";
}
...
?>
        ...
        <div class="content-wrapper">
            ...
            <!-- ///////////////////////section-1 //////-->
            <?php 
               $res = mysqli_query($con,"SELECT * FROM ride_ui WHERE section_name='section-1'");
                            ...
                            <div class="card card-outline card-info">
                                ...
                                <div class="card-header">
                                    <div class="form-group">
                                        ...
                                        <input name="title" value="<?php echo $row1["title"]; ?>" type="text"
                                ...
                                <!-- <div class="card-body pad">
                                    ...
                                    <div class="mb-3">
                                        <textarea name="descrip" placeholder="Description" style="width: 100%;"rows="5" cols="23"><?php //echo $row1["descrip"]; ?></textarea>
                                    </div>
                                </div> -->
                                 <div class="card-body pad">
                                    <label>Description</label>
                                    <div class="mb-3">
                                        <textarea name="descrip" class="textarea" placeholder="Place some text here"
                                            style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $row1["descrip"]; ?></textarea>
                                    </div>
                                </div>
            ...
            <!-- ///////////////////////end section-1 //////-->
              ...
              <!-- ///////////////////////section-2 //////-->
              <?php 
               $resultt = mysqli_query($con,"SELECT * FROM ride_ui WHERE section_name='section-2'");
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right py-0 align-middle">
                                            <div class="btn-group btn-group-sm">
                                                <a href="update-ride-sec-2.php?edit=<?php echo $roww["id"]; ?>"
                            ...
                            <table class="table">
                                ...
                                <tbody>
			                       ...
			                       while ($roww = mysqli_fetch_array($resultt)) { 	
			                         ?>
                                    <tr>
                                        <td><img style="width:50px;" src="../images/ride-img/<?php echo $roww["img"]; ?>">
                                        </td>
                                        <td><?php echo $roww["title"]; ?></td>
                                        <td><?php $dec = $roww['descrip'];
								$removetag = strip_tags($dec);
								...
								echo $trim ; ?>..</td>
                                        <td class="text-right py-0 align-middle">
                                            <div class="btn-group btn-group-sm">
                                                <a href="update-ride-sec-3.php?edit=<?php echo $roww["id"]; ?>" class="btn btn-info"><i
                                                        class="fas fa-edit"></i></a>
                                                <a href="#" onclick="return confirm('Are you sure?')"
                                                    class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                            </div>
            ...
            <!-- ///////////////////////section-3 End////////////-->
             ...
             <hr>
            <?php 
               $result = mysqli_query($con,"SELECT * FROM ride_ui WHERE section_name='section-4'");
                                ...
                                <div class="card-header">
                                    <div class="form-group">
                                        ...
                                        <p class="text-center"><img style="width:250px;"
                                                src="../images/ride-img/<?php echo $row["img"]; ?>"></p>
