      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-info">
			...
			?> 
				  <tr>
					<td><img style="width:150px;" src="../images/blog-img/<?php echo $roww["img"]; ?>"></td>
                    ...
                    <td class="text-right py-0 align-middle">
                      <div class="btn-group btn-group-sm">
						<a href="edit-blog.php?edit=<?php echo $roww["id"]; ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
