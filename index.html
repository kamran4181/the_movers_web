    ...
    <header>
     ...
     ?>
        <div class="section">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-white heading mt-4 pb-4">
<<<<<<< HEAD:index.php
                        <h1 class="mt-4 py-4 fw-bolder fs-1"><?php echo $row["title"]; ?></h1>
                        <p class="mb-4 fs-2"><?php echo $row["descrip"]; ?></p>
=======
                        <h1 class="mt-4 py-4 fw-bolder fs-1">Download app, Start drive, Earn money!</h1>
                        <p class="mb-4 fs-2">Become a Captain and start earning</p>
>>>>>>> 539ade5f49d8620cd9c79f7eaeacbed0260bbfe5:index.html
                        <!-- <a href="https://play.google.com/store/apps/details?id=com.execut.exactmoverdriver"
                            target="_blank" class="btn btn-prim text-white rounded-pill my-3 px-4">Become Captain</a> -->
                    ...
                    <div class="col-md-6 text-right mt-4" id="pic">
                        <!-- <img src="images/Mobile.png" class="slider-imgs"> -->
                        <img src="images/home-img/<?php echo $row["img"]; ?>" alt="" class="baner img-fluid">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container text-center">
            <div class="row my-4">
                <div class="col-md-12 mt-4">
                    <h1 class="text-4">Why Become a Captain</h1>
                </div>
                <div class="col-md-12 text-20">
                    <p>Lorem ipsum is common placeholder text used to demonstrate the graphic elements.</p>
                </div>
                <?php  
                ...
                <div class="col-md-4 mt-4">
                    <div class="card border-0" style="align-items: center;">
                        <img src="images/home-img/<?php echo $roww["img"]; ?>" width="45" height="37">
                        <div class="card-body text-20">
                            <h5 class="card-title"><b><?php echo $roww["title"]; ?></b></h5>
                            <p class="card-text"><?php echo $roww["descrip"]; ?></p>
                        </div>
                    </div>
                </div>
                <?php }?>
    ...
    <!-- /////////end become a captain/////// -->
    <?php 
          
    ?>
    <div class="section-slide my-4">
        <div class="container my-lg-4 py-lg-4">
        <?php 
        $res = mysqli_query($con,"SELECT * FROM home_ui WHERE section_name='section-3'");
        $rowww= mysqli_fetch_array($res);
     ?>
            <div class="row">
                <div class="col-md-12 my-4 pb-lg-4 text-center">
                    <h1><?php echo $rowww["title"];?></h1>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 mt-4 pb-4 slide-imgr">
                    <img src="images/home-img/slide-1.png" alt="" class="img img-1 slide-img show">
                    <img src="images/home-img/slide-2.png" alt="" class="img img-2 slide-img">
                    <img src="images/home-img/slide-3.png" alt="" class="img img-3 slide-img">
                    <img src="images/home-img/slide-4.png" alt="" class="img img-4 slide-img">
                </div>
                <div class="col-md-8 slider-text">
                    <div class="row mt-3">
                    <?php  
                     $resulttt = mysqli_query($con,"SELECT * FROM home_ui WHERE section_name='section-3'");
			         while ($rowww = mysqli_fetch_array($resulttt)) { 	
			        ?>
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-auto m-4 py-2 d-flex align-content-center">
                                    <img src="images/home-img/<?php echo $rowww["img"];?>" class="mt-2" width="50" height="50">
                                </div>
                                <div class="col my-4 py-3">
                                    <p class="card-text" style="font-size: 20px;"><?php echo $rowww["descrip"]; ?>
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    <!-- /////////////////////////////// -->
    <?php 
        $res = mysqli_query($con,"SELECT * FROM home_ui WHERE section_name='section-4'");
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <img src="images/home-img/<?php echo $data["img"];?>" class=" baner img-fluid">
                </div>
            </div>
        </div>
    </div>
